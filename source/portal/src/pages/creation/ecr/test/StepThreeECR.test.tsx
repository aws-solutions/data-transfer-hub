...
import StepThreeECR from "../StepThreeECR";
...
describe("StepThreeECR", () => {
  ...
  test("renders without errors", () => {
    (useMappedState as jest.Mock).mockReturnValue({
      tmpECRTaskInfo: {
        parametersObj: { sourceType: "ECR", srcImageList: "" },
      },
      amplifyConfig: {
    ...
    const { getByText } = render(<StepThreeECR />);
    const linkElement = getByText(/step.oneTitle/i);
