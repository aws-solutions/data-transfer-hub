...
1. Sign in to the Amazon Web Services Management Console and select the button to launch the `DataTransferHub-cognito.template` Amazon CloudFormation template. Alternatively, you can [download the template](https://s3.amazonaws.com/solutions-reference/data-transfer-hub/latest/DataTransferHub-cognito.template) as a starting point for your own implementation.
...
1. Sign in to the Amazon Web Services Management Console and select the button to launch the `DataTransferHub-openid.template` Amazon CloudFormation template. Alternatively, you can [download the template](https://s3.amazonaws.com/solutions-reference/data-transfer-hub/latest/DataTransferHub-openid.template) as a starting point for your own implementation. 
